        ...
        if self.download_dir_send.is_some() {
            let select_folder = cx.listener(|_this, _: &ClickEvent, _, cx| {
                let options = PathPromptOptions {
                    ...
                    multiple: false,
                    prompt: Some(
                        t::instance::content::manual_curseforge_downloads::choose_folder().into(),
                    ),
                };
            ...
            return modal
                ...
                .child(
                    v_flex()
                        ...
                        .child(div().w_full().whitespace_normal().child(
                            t::instance::content::manual_curseforge_downloads::description(),
                        ))
                        .child(
                            self.download_path
                    ...
                    .map(|file| {
                        ...
                        let trailing = if completed {
                            div()
                                ...
                                .child(
                                    t::instance::content::manual_curseforge_downloads::downloaded(),
                                )
                                .into_any_element()
                        } else {
                            ...
                            .child(
                                v_flex()
                                    ...
                                    .child(div().text_color(cx.theme().muted_foreground).child(
                                        ShrinkingText::new(SharedString::from(&file.filename)),
                                    )),
                            )
                            .child(trailing)
                            .h_12()
        ...
        modal
            ...
            .child(
                v_flex()
                    ...
                    .line_height(rems(1.2))
                    .child(
                        div().w_full().whitespace_normal().child(
                            t::instance::content::manual_curseforge_downloads::description(),
                        ),
                    )
                    .child(elements),
