...
#[derive(
    enum_map::Enum, Debug, strum::EnumIter, Clone, Copy, Hash, PartialEq, Eq, PartialOrd, Ord,
)]
...
pub enum ModpackFileSource {
    DownloadUrl { url: Arc<str>, size: usize },
    DownloadCurseforge { file_id: u32 },
    Builtin { bytes: Arc<[u8]> },
}
