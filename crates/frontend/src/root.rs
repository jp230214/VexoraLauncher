        ...
        match live_game_output_display {
            ...
            LiveGameOutputDisplay::SeparateWindow => {
                ...
                _ = cx.open_window(options, |window, cx| {
                    ...
                    let game_output_root =
                        cx.new(|cx| GameOutputRoot::new(game_output.clone(), window, cx));
            ...
            LiveGameOutputDisplay::TabOnInstancePage => {
                _ = cx.update_window(window_handle, |_, window, cx| {
                    ...
                    let Some(instance_entry) = data.instances.read(cx).entries.get(&id).cloned()
                    else {
                        return;
                    };
                    ...
                    {
                        InterfaceConfig::get_mut(cx).instance_subpage =
...
pub fn upload_log_file(
    ...
    modals::generic::show_modal(
        ...
        cx,
        title,
        t::instance::logs::upload::error().into(),
        modal_action,
    );
}
