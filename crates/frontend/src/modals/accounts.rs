    ...
    fn render(&mut self, window: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        let items = accounts
            ...
            .filter_map(|(account_index, account)| {
                ...
                let previous_shift_amount = self
                    .shift_amounts
                    .get(account_index)
                    .copied()
                    .unwrap_or(0.0);
                            ...
                            Button::new(("account-delete", account_index))
                                ...
                                .on_click({
                                    ...
                                    move |_, _, cx| {
                                        cx.stop_propagation();
                                        backend_handle
                                            .send(MessageToBackend::DeleteAccount { uuid });
                                    }
                                }),
                        )
                        .into_any_element(),
