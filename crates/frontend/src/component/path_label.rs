...
use gpui::{
    AvailableSpace, Element, ElementId, IntoElement, ParentElement, ShapedLine, SharedString, Size,
    Style, Styled, TextStyle, px,
};
        ...
        let layout_id = window.request_measured_layout(Style::default(), {
            ...
            move |known_dimensions, available_space, _window, _cx| {
                ...
                let width = if let Some(pixels) = known_dimensions.width {
                    last_definite_width.store(
                        pixels.as_f32().ceil() as u32,
                    ...
                    match available_space.width {
                        ...
                        AvailableSpace::MaxContent => {
                            let last_definite_width =
                                last_definite_width.load(std::sync::atomic::Ordering::Relaxed);
