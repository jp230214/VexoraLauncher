use gpui::{
    AnyElement, AvailableSpace, Bounds, ContentMask, Element, InteractiveElement, Interactivity,
    IntoElement, ParentElement, Pixels, Point, Size, StyleRefinement, Styled, px, size,
};
            ...
            |style, _scroll_offset, _hitbox, window, cx| {
                ...
                let bounds = Bounds {
                    origin: bounds.origin.clone()
                        + gpui::point(padding.left.clone(), padding.top.clone()),
                ...
                if available_space_for_children > Pixels::ZERO {
                    ...
                    for (index, child) in self.children.iter_mut().enumerate() {
                        ...
                        let child_bounds = Bounds {
                            ...
                            size: Size::new(
                                width + gap_width - px(1.0),
                                original_bounds.size.height,
                            ),
                        };
