...
use crate::{
    ...
    entity::DataEntities,
    icon::PandoraIcon,
    interface_config::{DEFAULT_FONT, DEFAULT_FONT_SIZE, DEFAULT_THEME, InterfaceConfig},
...
pub(super) fn create_page(data: &DataEntities, window: &mut Window, cx: &mut App) -> SettingPage {
    SettingPage {
        ...
        groups: vec![
            SettingGroup {
                ...
                items: vec![
                    SettingItem {
                        ...
                        reset: Some(|cx| {
                            InterfaceConfig::get_mut(cx).set_active_theme(DEFAULT_THEME.into());
                    ...
                    SettingItem {
                        ...
                        reset: Some(|cx| {
                            InterfaceConfig::get_mut(cx).set_font_family(DEFAULT_FONT.into());
                            InterfaceConfig::apply_theme(cx, true);
                        }),
                        ..Default::default()
                    },
                    SettingItem {
                        ...
                        reset: Some(|cx| {
                            InterfaceConfig::get_mut(cx).set_font_size(DEFAULT_FONT_SIZE);
                            InterfaceConfig::apply_theme(cx, true);
                        }),
                        ..Default::default()
                    },
            ...
            SettingGroup {
                title: Some(t::settings::appearance::preview),
                items: vec![SettingItem {
                    title: t::settings::appearance::preview::player_model_zoom,
                    description: t::settings::appearance::preview::player_model_zoom_desc,
                    widget: SettingItemWidget::Integer {
                        get: |cx| InterfaceConfig::get(cx).player_model_zoom,
                        set: |val, cx| {
                            InterfaceConfig::get_mut(cx).player_model_zoom = val.clamp(50, 400);
                            cx.refresh_windows();
                        },
                        min: Some(50),
                        max: Some(400),
                    ...
                    reset: Some(|cx| {
                        InterfaceConfig::get_mut(cx).player_model_zoom =
                            crate::interface_config::DEFAULT_PLAYER_MODEL_ZOOM;
                        cx.refresh_windows();
                    }),
                    ..Default::default()
                }]
            ...
            SettingGroup {
                ...
                items: vec![
                    ...
                    SettingItem {
                        ...
                        description:
                            t::settings::appearance::window::quit_when_main_window_closed_desc,
                        widget: SettingItemWidget::Switch(
